...
const Education = () => {
    return (
        ...
        <h1 className='text-2xl mb-12 mt-10 ml-5 lg:flex justify-end font-cursive  lg:mr-1 about-title'>My Education.....</h1>

            <div class="box-container grid lg:grid-cols-3 gap-10 ">
                <div class="box" style={{ borderLeft: ".2rem solid white" }} >

                    <p className='icon'><FaGraduationCap className='text-4xl ml-5 mt-3 text-black' /></p>
